...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { name: @score.name, result: @score.result, title: @score.title } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { name: @score.name, result: @score.result, title: @score.title } }
